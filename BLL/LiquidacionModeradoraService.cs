...
namespace BLL
{
    public class LiquidacionCuotaModeradoraService
    {
        ...
        private readonly LiquidacionCuotaRepository repositorio;
        
        public LiquidacionCuotaModeradoraService(string connectionString)
        {
            conexion = new ConnectionManager(connectionString);
            repositorio = new LiquidacionCuotaRepository(conexion);
        }
